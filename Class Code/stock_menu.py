...
def add_stock(stock_list):
    ...
    while option != "0":
        ...
        option = input("Press Enter to add another, or Enter 0 to exit: ")
...
def list_stocks(stock_list):
    print("Stick List: ")
    print("SYMBOL\t\t\tNAME\t\t\tSHARES\t\t\tPRICE\t\t\tVALUE")
    print("========================================================================")
    for stock in stock_list:
        print(stock.symbol, " " * (14 - len(stock.symbol)), stock.name, " " * (14 - len(stock.name)), stock.shares, " " * (14 - len(str(stock.shares))))
    print()
    _=input("Press enter to continue")
...
def display_report(stock_list):
    ...
    for stock in stock_list:
        ...
        if count > 0:
            ...
            print(f'High Volume: {highVolume}')
            print(f'Average Volume: {volume_total/count}')
